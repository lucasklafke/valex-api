...
export function purchase(cardId, password, amount, businessId) {
    return __awaiter(this, void 0, void 0, function () {
        var card, cryptr, decryptPassword, business, balance;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    decryptPassword = decryptNumber(card.password, cryptr);
                ...
                case 2:
                    ...
                    return [4 /*yield*/, getBalance(cardId)];
                case 3:
                    balance = _a.sent();
